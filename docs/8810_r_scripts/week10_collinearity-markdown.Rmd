...
Of course, the easiest correction to a high VIF is to drop one of the variables, especially if it is measuring something very similar to the variable it is correlated with, and if whatever differences in measurement do exist are not theoretically important. Let's compare models that drop one of our correlated predictors.
