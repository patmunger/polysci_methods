...
- Estimate linear model with lm() and glm(), compare
- Test Gauss-Markov Assumptions
...
#stargazer(lm_model, glm_model, type = "latex")
```
...
We want our residuals to be independently and identically distributed normally around 0. While this does not test the independence, we can plot a histogram to check the distribution of our residuals. We can also create a QQ plot of the residuals to check normality. 
