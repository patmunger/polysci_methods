...
Marginal effects can help us gauge the relationship across values of our IV. They tell us how the probability of the event CHANGES (NOT the probability OF the event) at each value of 'x'. This is distrinct from ORs which are constant across the values of each predictor.
...
```{r}
avg_slopes(logit2, variables = "k5") # AME on the probability scale
