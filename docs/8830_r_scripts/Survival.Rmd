...
In this case, our time variable is `dtime`, which is a count of days (I assume) from the start of the trial to death or last follow up. Our survival variable is `death`, a binary indicating if the patient dies during the trial. 
