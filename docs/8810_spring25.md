...
[Problem Set 2: Most Common Problems](8810_ps/)
...
Refer to the Markdown file for expanded demonstrations, annotations, and explanations of in class demonstrations. Refer to R-file for simplified code as well as code to produce coefficient plot comparing models with a numerically coded and factored out ordinal variable. Additionally, refer to the R-file for advanced transformations. 
- R file: [Dichotomous Predictors R Script](8810_r_scripts/week6_multiple.R)
- RMarkdown file: [Dichotomous Predictors RMarkdown Script](8810_r_scripts/week6_multiple-markdown.Rmd)
