...
# Week 9: Survival/Duration/Hazard Models

### Slides
[Survival/Duration Slides](8830_slides/10Duration.pdf)
### R Scripts 
[Survival/Duration/Hazard/Event History Models Markdown](8830_r_scripts/Survival.Rmd)
### Applied Examples
...
- ["Survival of the Fittest? Cabinet Duration in Postcommunist Europe" (Somer-Topcu & Williams, 2008)](https://www.ingentaconnect.com/content/cuny/cp/2008/00000040/00000003/art00004)
- ["The Initiative Process and Policy Innovation in the American States" (LaCombe & Boehmke, 2021)](https://www.cambridge.org/core/journals/state-politics-and-policy-quarterly/article/initiative-process-and-policy-innovation-in-the-american-states/721110EE50A530AE94FCDCF6996E9A75)

### Using Expected Durations for Applied Political Science (coxed package)
- ["Beyond the Hazard Ratio: Generating Expected Durations from the Cox Proportional Hazards Model" (Kropko & Harden, 2017)](https://www.cambridge.org/core/journals/british-journal-of-political-science/article/beyond-the-hazard-ratio-generating-expected-durations-from-the-cox-proportional-hazards-model/B161DC9C5C9C83B16B27E2578F35FCBB)
- Note: The coxed package is no longer mantained on CRAN but the latest version can be installed from the archives with RTools from [here](https://cran.r-project.org/src/contrib/Archive/coxed/)
...
### R Scripts 
[Count Models Markdown](8830_r_scripts/Count.Rmd)
### Data
...
### Template Model Builder Package
See CRAN page for the `glmmTMB` package [here](https://cran.r-project.org/web/packages/glmmTMB/index.html) and further documentation and instructions [here](https://share.google/iFhrA5aWZQ4Mi3dDZ)


# Week 11: Nested Models 

### Slides
[Nested Slides](8830_slides/11Multilevel.pdf)
### R Scripts
[Nested Models](8830_r_scripts/Nested.Rmd)
### Data
